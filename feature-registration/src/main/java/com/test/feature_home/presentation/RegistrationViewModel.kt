...
class RegistrationViewModel @Inject constructor(
    ...
    fun checkSignInAndSaveUser(name: String, lastName: String, email: String) {
        Log.d(VALIDATE_FIELD_AND_SAVE, "$name $lastName $email")
        ...
        val user = UserResult(name, lastName, email, DEFAULT_PASSWORD)
    ...
    companion object{
        private const val GET_USERS_DB = "GET_USERS_DB"
        private const val VALIDATE_FIELD_AND_SAVE = "VALIDATE_FIELD_AND_SAVE"
        private const val DEFAULT_PASSWORD = "1111"
    }
